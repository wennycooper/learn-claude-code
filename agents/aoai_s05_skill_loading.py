#!/usr/bin/env python3
# Harness: on-demand knowledge -- Azure OpenAI GPT-4o version
"""
aoai_s05_skill_loading.py - Skills (Azure OpenAI Version)
...
Also includes TodoManager + nag reminder from s03.
...
def agent_loop(messages: list):
    ...
    while True:
        ...
        # Append all tool results as separate messages
...
if __name__ == "__main__":
    history = []
    print("\033[32mAzure OpenAI GPT-4o Agent with Skills + TodoWrite\033[0m")
    print("Type 'q', 'exit', or press Ctrl+C to quit\n")

    while True:
        try:
            query = input("\033[36maoai-s05 >> \033[0m")
